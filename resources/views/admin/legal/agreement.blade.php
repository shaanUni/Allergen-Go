...
<article class="privacy-policy">
  ...
  <p class="effective-date"><strong>Effective Date:</strong> [Insert Date] <span><strong>Version:</strong> 1.0</span> <span><strong>Provider:</strong> AllergenGo</span> <span><strong>Contact:</strong> [Insert Contact Email]</span></p>
  ...
  <section>
    ...
    <ul>
      <li>Our online software for receiving and responding to user allergy submissions</li>
      <li>An admin dashboard for viewing matched dishes and optional analytics</li>
  ...
  <section>
    ...
    <ul>
      ...
      <li>Additional locations require additional/separate subscriptions</li>
    </ul>
    <h3>🏢 Multi-Site or Chains</h3>
    <p>If you operate multiple restaurants or locations under one brand, you must:</p>
    <ul>
      <li>Contact us to arrange a multi-location agreement (or have each branch purchase AllergenGo separately)</li>
      <li>Register and pay for each site or secure a chain-wide license</li>
  ...
  <section>
    ...
    <ul>
      <li>Subscription fee: £25/month per location</li>
      <li>Billing is handled via Stripe</li>
      <li>Subscriptions auto-renew monthly unless canceled in advance</li>
      <li>No refunds are offered for partial months or unused access</li>
    </ul>
  </section>

  <section>
    <h2>5. Access Restrictions</h2>
    <p>Access is limited to one location per subscription.</p>
  </section>
  ...
  <section>
    ...
    <p>This Agreement supplements our full <a href="/terms-of-service">Terms of Service</a> and <a href="/privacy-policy">Privacy Policy</a>, which govern all use of the platform, including:</p>
    <ul>
  ...
  <section>
    <h2>9. Contact</h2>
    <p>If you have questions about this Agreement, please contact us at: <a href="mailto:[Insert support email]">[Insert support email]</a></p>
  </section>

  <section>
    <h2>✅ Summary</h2>
    <ul>
      <li>£25/month per location</li>
      <li>One IP address per subscription</li>
      <li>Chain licenses available — contact us or have each branch purchase AllergenGo</li>
